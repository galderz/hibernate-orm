...
public final class TemporalEntityKey implements EntityKey {
	...
	public TemporalEntityKey(@Nullable Object id, EntityPersister persister, Object changesetId) {
		this.entityKey = new EntityKeyVC( id, persister, changesetId.hashCode() );
		this.changesetId = changesetId;
	}

	@Override
	public boolean isBatchLoadable(LoadQueryInfluencers influencers) {
		return entityKey.isBatchLoadable( influencers );
	}

	@Override
	public Object getIdentifierValue() {
		return entityKey.getIdentifierValue();
	}
	...
	public String getEntityName() {
		return entityKey.getEntityName();
	}

	@Override
	public EntityPersister getPersister() {
		return entityKey.getPersister();
	}
	...
	public String toString() {
		return entityKey.toString() + "@" + changesetId;
	}
}
